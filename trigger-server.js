...
app.post('/trigger-call', async (req, res) => {
  ...
  try {
    ...
    const retellResponse = await axios.post('https://api.retellai.com/v1/calls/create-phone-call', {
...
app.post('/trigger-retell-call', async (req, res) => {
  try {
    ...
    const response = await axios.post('https://api.retellai.com/v1/calls/create-phone-call', {
      from_number: process.env.RETELL_FROM_NUMBER,
      to_number: phone,
      agent_id: process.env.RETELL_AGENT_ID,
      metadata: {
